...
return [
    ...
    'site' => [
        ...
        'site_info' => 'Enable/disable website for your clients.',
    ],
    'server' => [
        'server' => 'Server Config',
        'server_config' => 'Server Configuration',
        'server_info' => 'Configure server to create dynamic database for your clients.',
        'test_connection' => 'Test Server Connection',
        'db_prefix_no_trailing_underscore' => 'Database prefix must end with underscore.',
        'connection_successful' => 'Connection successful.',
        'invalid_db_prefix' => 'Invalid database prefix.',
        'props' => [
            'platform' => 'Hosting Platform',
            'platform_local' => 'No Platform',
            'platform_cpanel' => 'cPanel',
            'cpanel_username' => 'cPanel Username',
            'cpanel_hostname' => 'cPanel Hostname',
