...
import smsTemplate from "@stores/modules/config/smsTemplate"
import pushNotificationTemplate from "@stores/modules/config/pushNotificationTemplate"
...
const config = {
    ...
    actions: {
        ...
        async modulePreRequisite({ state, commit }, payload) {
            let url = state.initAppURL + "/module-pre-requisite"
            return Api.custom({
                url,
                method: "GET",
            })
        ...
        async storeModule({ state, commit }, payload) {
            return await Api.custom({
                url: state.initAppURL + "/module",
                method: "POST",
                data: payload.form,
            })
                .then((response) => {
        ...
        async testSMS({ state, commit }, payload) {
            return await Api.custom({
                url: state.initAppURL + "/sms/test",
                method: "GET",
            })
                .then((response) => {
                    commit("SET_FORM_ERRORS", {})
        ...
        async testServerConnection({ state, commit }, payload) {
            return await Api.custom({
                url: state.initAppURL + "/server/test",
                method: "GET",
            })
                .then((response) => {
                    commit("SET_FORM_ERRORS", {})
