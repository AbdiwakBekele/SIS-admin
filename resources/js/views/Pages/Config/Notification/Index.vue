        ...
        >
            ...
            <div class="grid grid-cols-3 gap-6">
                <div class="col-span-3 sm:col-span-1">
                    <BaseSwitch
                        reverse
                        v-model="form.enableMailNotification"
                        name="enableMailNotification"
                        :label="
                            $trans(
                                'config.notification.props.mail_notification'
                            )
                        "
                        v-model:error="formErrors.enableMailNotification"
                    />
                </div>
                <div class="col-span-3 sm:col-span-1">
                    <BaseSwitch
                        reverse
                        v-model="form.enableMobilePushNotification"
                        name="enableMobilePushNotification"
                        :label="
                            $trans(
                                'config.notification.props.mobile_push_notification'
                            )
                        "
                        v-model:error="formErrors.enableMobilePushNotification"
                    />
                </div>
            </div>
...
const initForm = {
    ...
    enableMobilePushNotification: false,
