            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div class="col-span-3 sm:col-span-1">
                    <BaseSelect
                        v-model="form.theme"
                        name="theme"
                        :label="$trans('config.system.props.theme')"
                        :options="preRequisites.themes"
                        v-model:error="formErrors.theme"
                    />
                </div>
                <div class="col-span-3 sm:col-span-1">
                    <BaseSelect
                ...
                <div class="col-span-3">
                    <BaseSwitch
                        vertical
                        v-model="form.enableStrongPassword"
                        name="enableStrongPassword"
                        :label="
                            $trans('global.enable', {
                                attribute: $trans(
                                    'config.system.props.strong_password'
                                ),
                            })
                        "
                        v-model:error="formErrors.enableStrongPassword"
                    />
                </div>
            </div>
