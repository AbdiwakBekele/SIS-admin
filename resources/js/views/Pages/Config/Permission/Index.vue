    ...
    <ConfigPage>
        <template #action>
            <div class="space-x-4">
                ...
                >
                    <div
                        v-for="module in preRequisites.modules"
                        :key="module.value"
                    >
                ...
                <BaseButton
                    @click="router.push({ name: 'ConfigUserPermission' })"
                    >{{
                        $trans("config.permission.user_permission")
                    }}</BaseButton
                >
            </div>
        </template>
        ...
        >
            <CardHeader
                first
                :title="$trans('config.permission.permission_config')"
                :description="$trans('config.permission.permission_info')"
            ></CardHeader>
                ...
                >
                    ...
                    >
                        <thead class="bg-gray-50 dark:bg-neutral-700">
                            <tr>
                                <th
                                    class="sticky-column bg-gray-50 dark:bg-neutral-700 px-6 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-gray-400"
                                >
                                    {{ $trans("config.permission.permission") }}
                                </th>
                                <th
                        ...
                        >
                            ...
                            >
                                <td
                                    class="sticky-column bg-white dark:bg-dark-body py-2 pl-6 text-sm text-gray-500 dark:text-gray-400"
                                >
