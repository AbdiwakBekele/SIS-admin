        ...
        >
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div class="col-span-3">
                    <BaseInput
                        type="text"
                        v-model="form.metaAuthor"
                        name="metaAuthor"
                        :label="$trans('config.general.props.meta_author')"
                        v-model:error="formErrors.metaAuthor"
                    />
                </div>
                <div class="col-span-3">
                    <BaseInput
                        ...
                        :label="$trans('config.general.props.meta_description')"
                        v-model:error="formErrors.metaDescription"
                    />
                </div>
                <div class="col-span-3">
                    <BaseInput
                        ...
                        name="metaKeywords"
                        :label="$trans('config.general.props.meta_keywords')"
                        v-model:error="formErrors.metaKeywords"
                    />
                </div>
            </div>
            <CardHeader
            ...
            <div class="grid grid-cols-3 gap-4">
                <div class="col-span-3 sm:col-span-1">
                    <BaseInput
                        ...
                        :label="
                            $trans('config.general.props.app_address_line1')
                        "
                ...
                <div class="col-span-3 sm:col-span-1">
                    <BaseInput
                        type="text"
                        v-model="form.appAddressLine2"
                        name="appAddressLine2"
                        :label="
                            $trans('config.general.props.app_address_line2')
                        "
                        v-model:error="formErrors.appAddressLine2"
                    />
                </div>
                <div class="col-span-3 sm:col-span-1">
                    <BaseInput
