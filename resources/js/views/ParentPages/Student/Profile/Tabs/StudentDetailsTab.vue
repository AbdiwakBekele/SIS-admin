...
<template>
    ...
    <div class="bg-white rounded-lg border-r pr-6 py-3 text-center mt-2">
        ...
        <div class="grid grid-cols-10">
            <div v-for="(slot, index) in academicTermSlots" :key="index"
                class="col-span-2 grid grid-cols-4 m-2 py-2 rounded-lg shadow hover:border hover:border-gray-300">
    ...
    <div class="bg-white rounded-lg border-r pr-6 py-5 text-center mt-2">
        ...
        <div v-for="activity in student.studentSchoolActivities" class="bg-gray-200 rounded-lg mx-4 my-2 p-2">
    ...
    <div class="bg-white rounded-lg border-r pr-6 py-5 text-center mt-2">
        ...
        <div class="grid grid-cols-12">
            <div v-if="student.contact && student.contact.documents && student.contact.documents.length > 0"
                v-for="document in student.contact.documents" :key="document.uuid"
