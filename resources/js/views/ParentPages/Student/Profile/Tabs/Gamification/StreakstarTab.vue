        ...
        <div>
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-gray-600 text-sm">Streak stars {{ studentName }} has successfully earned</p>
                </div>
            </div>
            ...
            <div v-if="earnedStreakStars.length === 0" class="text-center py-12 bg-gray-50 rounded-xl border border-gray-200">
                ...
                <p class="text-sm text-gray-500">{{ studentName }} hasn't earned any streak stars yet</p>
            </div>
        ...
        <div>
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-gray-600 text-sm">Streak stars {{ studentName }} can earn</p>
                </div>
            </div>
