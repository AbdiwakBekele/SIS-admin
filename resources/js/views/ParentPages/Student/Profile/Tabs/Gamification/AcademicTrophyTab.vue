        ...
        <div>
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-gray-600 text-sm">Academic trophies {{ studentName }} has successfully earned</p>
                </div>
            </div>
            ...
            <div v-if="earnedTrophies.length === 0" class="text-center py-12 bg-gray-50 rounded-xl border border-gray-200">
                ...
                <p class="text-sm text-gray-500">{{ studentName }} hasn't earned any trophies yet</p>
            </div>
        ...
        <div>
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-gray-600 text-sm">Academic trophies {{ studentName }} can earn</p>
                </div>
            </div>
