                ...
                >
                    <div class="flex items-center">
                        ...
                        <div class="font-medium dark:text-white">
                            {{ chat.name }}
                            <TextMuted block v-if="chat.recipient">
                                <i
                                    class="fas fa-graduation-cap"
                                    v-if="chat.recipient.type == 'student'"
                                    v-tooltip="$trans('student.student')"
                                ></i>
                                <i
                                    class="fas fa-user-tie"
                                    v-if="chat.recipient.type == 'employee'"
                                    v-tooltip="$trans('employee.employee')"
                                ></i>
                                {{ chat.recipient.detail }}</TextMuted
                            >
                            <TextMuted
                                class="mt-1"
                                block
                                v-if="chat.latestMessage"
                                >{{ chat.latestMessage.content }}</TextMuted
                            >
                        </div>
                    </div>
                    <div>
        ...
        <template v-else>
            ...
            >
                ...
                >
                    ...
                    <div class="font-medium dark:text-white">
                        {{ user.name }}
                        <TextMuted block v-if="user.detail">
                            <i
                                class="fas fa-graduation-cap"
                            ...
                            <i
                                class="fas fa-user-tie"
                                v-if="user.userType == 'employee'"
                                v-tooltip="$trans('employee.employee')"
                            ></i>
                            {{ user.detail }}</TextMuted
                        >
                    </div>
                </div>
            </li>
