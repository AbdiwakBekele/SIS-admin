        ...
        <div>
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-gray-600 text-sm">Attendance ribbons you've successfully earned</p>
                </div>
            </div>
            ...
            <div v-if="earnedRibbons.length === 0" class="text-center py-12 bg-gray-50 rounded-xl border border-gray-200">
                ...
                <p class="text-sm text-gray-500">Start earning ribbons by maintaining perfect attendance!</p>
            </div>
        ...
        <div>
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-gray-600 text-sm">Attendance ribbons you can earn</p>
                </div>
            </div>
