        ...
        <div>
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-gray-600 text-sm">Challenges you're currently participating in</p>
                </div>
            </div>
            ...
            <div v-if="acceptedChallenges.length === 0" class="text-center py-12 bg-gray-50 rounded-xl border border-gray-200">
                ...
                <p class="text-sm text-gray-500">You haven't accepted any challenges yet</p>
            </div>
        ...
        <div>
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-gray-600 text-sm">New challenges you can participate in</p>
                </div>
            </div>
        ...
        <div>
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-gray-600 text-sm">Completed and withdrawn challenges</p>
                </div>
            </div>
