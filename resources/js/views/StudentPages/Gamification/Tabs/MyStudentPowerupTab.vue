        ...
        <div>
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-gray-600 text-sm">Powerups you've successfully earned</p>
                </div>
            </div>
            ...
            <div v-if="earnedPowerups.length === 0" class="text-center py-12 bg-gray-50 rounded-xl border border-gray-200">
                ...
                <p class="text-sm text-gray-500">Start earning powerups by completing challenges!</p>
            </div>
        ...
        <div>
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-gray-600 text-sm">Powerups you can earn</p>
                </div>
            </div>
