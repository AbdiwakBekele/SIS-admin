...
import StudentTranscriptRequestModal from "./StudentTranscriptRequestModal.vue"
...
function downloadTranscriptPdf() {
    const url = router.resolve({ name: 'MyStudentTranscriptPrint' }).href
...
const items = computed(() => {
    ...
    // Previous school records are always shown (they don't have publish status)
...
function goToPrintPreview() {
    router.push({ name: 'MyStudentTranscriptPrint' })
}
