            ...
            <div class="grid grid-cols-11 gap-2 p-3 shadow-md">
                ...
                <div class="col-span-9 rounded-lg">
                    ...
                    <div class="mt-2">
                        ...
                        <div v-if="false && activeTab === 'Gamification'">

                            <div class="p-6 bg-gray-50 min-h-screen rounded-lg my-2">
                            ...
                            <!-- Challenges -->
                            <div class="bg-white rounded-lg p-6 my-2">
                                <div class="flex justify-between items-center mb-4">
                                    <h3 class="text-sm font-semibold">Challenges</h3>
                                    <button @click="router.push({ name: 'QuestCreate' })"
                                ...
                                <table class="w-full table-auto text-sm">
                                    <thead>
                                        <tr class="bg-gray-100">
                                            <th class="px-4 py-2 text-left">Challenges</th>
                                            <th class="px-4 py-2 text-left">Category</th>
                                            <th class="px-4 py-2 text-left">Max Points</th>
                                    ...
                                    <tbody>
                                        <tr v-for="ch in challenges" :key="ch.id" class="border-b">
                                            <td class="px-4 py-2">{{ ch.title }}</td>
                                            <td class="px-4 py-2">{{ ch.category }}</td>
                                            <td class="px-4 py-2">{{ ch.points }}</td>
                                            <td class="px-4 py-2">{{ ch.startDate }}</td>
                                            <td class="px-4 py-2">{{ ch.endDate }}</td>
                                            <td class="px-4 py-2"> <span
                                                    @click="router.push({ name: 'ChallengesViewDetail' })"
                                                    class="cursor-pointer text-blue-600 hover:text-blue-800">
                                                    View Details
                                                </span></td>
                            ...
                            <div class="bg-white rounded-lg p-6 my-2">
                                <div class="flex justify-between items-center mb-4">
                                    <h3 class="text-sm font-semibold">Gamification Summary</h3>
                                </div>
                                <table class="w-full table-auto text-sm">
                                    <thead>
                                        <tr class="bg-gray-100">
                                            ...
                                            <th class="px-4 py-2 text-left">Challenges Completed</th>
                                            <th class="px-4 py-2 text-left">Badges Earned</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr v-for="gm in gamification" :key="gm.studentId" class="border-b">
                                            <td class="px-4 py-2">{{ gm.studentName }}</td>
                                            <td class="px-4 py-2">{{ gm.score }}</td>
                                            <td class="px-4 py-2">{{ gm.challenges }}</td>
                                            <td class="px-4 py-2">{{ gm.badges }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="bg-white rounded-lg p-6 my-2">
                                <div class="flex justify-between items-center mb-4">
                                    <h3 class="text-sm font-semibold">Past Challenges</h3>
                                ...
                                <table class="w-full table-auto text-sm">
                                    ...
                                    <tbody>
                                        <tr v-for="ch in pastChallenges" :key="ch.id" class="border-b">
                                            <td class="px-4 py-2">{{ ch.title }}</td>
                                            <td class="px-4 py-2">{{ ch.category }}</td>
                                            <td class="px-4 py-2">{{ ch.points }}</td>
                                            <td class="px-4 py-2">{{ ch.startDate }}</td>
...
const initUrl = 'transport/transportDetail/'
const setItem = (data) => {
    // merge fetched course data into our reactive `course`
...
const gamification = ref([
    { studentId: 1, studentName: 'Alice Johnson', score: 240, challenges: 12, badges: 3 },
    { studentId: 2, studentName: 'Bob Smith', score: 190, challenges: 10, badges: 2 },
    { studentId: 3, studentName: 'Carol Lee', score: 275, challenges: 15, badges: 4 },
    // ...more students
])
...
// Dummy participant data with weekly stats
const participants = ref([
    { id: 1, name: 'John Smith K.', points: 120, challengesCompleted: 5, badgesEarned: 3, attendanceStreak: 7 },
    { id: 2, name: 'Janet Assefa', points: 95, challengesCompleted: 4, badgesEarned: 2, attendanceStreak: 6 },
    { id: 3, name: 'Alazar T.', points: 150, challengesCompleted: 6, badgesEarned: 4, attendanceStreak: 5 },
    { id: 4, name: 'Nati C.', points: 80, challengesCompleted: 3, badgesEarned: 1, attendanceStreak: 7 },
    { id: 5, name: 'Bob Smith', points: 110, challengesCompleted: 5, badgesEarned: 2, attendanceStreak: 4 },
    { id: 6, name: 'Carol Lee', points: 130, challengesCompleted: 7, badgesEarned: 5, attendanceStreak: 7 },
])

// Define week range (could be dynamic)
const weekStart = 'May 19, 2025'
const weekEnd = 'May 25, 2025'

// Helper to get top 5 sorted by a given key
function topBy(key) {
    return computed(() =>
        [...participants.value]
