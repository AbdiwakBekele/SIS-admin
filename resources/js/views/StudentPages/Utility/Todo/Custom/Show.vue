<template>
    <PageHeader :title="$trans(route.meta.trans, {
        ...
        <PageHeaderAction name="UtilityTodo" :title="$trans('utility.todo.todo')" :actions="['list']" />
    </PageHeader>
        ...
        <ShowItem :init-url="initUrl" :uuid="route.params.uuid" @setItem="setItem"
            ...
            <BaseCard v-if="todo.uuid">
                ...
                <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                    ...
                    <template v-for="field in todo.customFields || []" :key="field.uuid">
                        <BaseDataView :label="field.label">
