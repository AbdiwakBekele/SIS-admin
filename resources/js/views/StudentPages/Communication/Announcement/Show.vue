<template>
    <PageHeader
        ...
        :navs="[
            ...
            },
            {
                ...
                path: 'StudentCommunicationAnnouncementList',
            },
        ]"
    >
        <PageHeaderAction
            name="StudentCommunicationAnnouncement"
    ...
    <ParentTransition appear :visibility="true">
        <ShowItem
            ...
            @redirectTo="
                router.push({
                    name: 'StudentCommunicationAnnouncementList',
                })
            "
        >
            <BaseCard
            ...
            >
                ...
                >
                    ...
                    <BaseDataView
                        class="col-span-1 sm:col-span-2"
                        v-if="announcement.media && announcement.media.length > 0"
                    >
                        <ListMedia
                        ...
                        <BaseCard no-padding no-content-padding>
                            ...
                            <ListContainerVertical>
                                ...
                                <ListItemView
                                    ...
                                    "
                                >
                                    {{ announcement.type ? announcement.type.name : '-' }}
                                </ListItemView>
