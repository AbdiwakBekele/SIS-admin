...
class SysHelper
{
    ...
    {
        if (\Storage::disk('local')->exists('.reinstall')) {
            return false;
        }
     ...
     */
    public static function getTenantPath(string $file): string
    {
        return base_path(config('app.tenant_path').$file);
    }

    /**
     * Write to env file
     */
    public static function setEnv(array $data = [], string $file = ''): bool
    {
