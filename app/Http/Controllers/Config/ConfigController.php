...
use App\Actions\Config\TestServerConnection;
...
class ConfigController extends Controller
{
     ...
     */
    public function testServerConnection(Request $request, TestServerConnection $action)
    {
        $action->execute($request);

        return response()->success(['message' => trans('config.server.connection_successful')]);
    }
